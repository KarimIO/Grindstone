...
namespace Grindstone {
	namespace GraphicsAPI {
		VkFilter TranslateFilterToDirectX11(TextureFilter f) {
			switch (f) {
		...
		VkSamplerAddressMode TranslateWrapToDirectX11(TextureWrapMode m) {
			switch (m) {
		...
		VkFormat TranslateVertexFormatsToDirectX11(VertexFormat format) {
			switch (format) {
		...
		ColorFormat TranslateColorFormatFromDirectX11(VkFormat format) {
			switch (format) {
		...
		DepthFormat TranslateDepthFormatFromDirectX11(VkFormat format) {
			switch (format) {
		...
		VkFormat TranslateColorFormatToDirectX11(ColorFormat in, uint8_t &channels) {
			switch (in) {
			case ColorFormat::R8:
				channels = 1;
		...
		VkFormat TranslateDepthFormatToDirectX11(DepthFormat in) {
			switch (in) {

...
StatusBar::StatusBar(ImguiRenderer* imguiRenderer) {
	gitBranchIcon = imguiRenderer->CreateTexture("gitIcons/GitBranch");
	gitAheadBehindIcon = imguiRenderer->CreateTexture("gitIcons/GitAheadBehind");
	gitChangesIcon = imguiRenderer->CreateTexture("gitIcons/GitChanges");
}

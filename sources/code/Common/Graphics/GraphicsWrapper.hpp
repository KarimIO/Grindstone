...
namespace Grindstone {
	...
	namespace GraphicsAPI {
		...
		public:
			...
			virtual bool initialize(Core::CreateInfo& createInfo) = 0;
		...
		public:
			...
			virtual void clear(ClearMode mask, float clear_color[4], float clear_depth = 0.f, uint32_t clear_stencil = 0u) = 0;

...
void LibRocketRenderInterface::RenderGeometry(Rocket::Core::Vertex* vertices, int ROCKET_UNUSED_PARAMETER(num_vertices), int* indices, int num_indices, const Rocket::Core::TextureHandle texture, const Rocket::Core::Vector2f& translation)
{
...
void LibRocketRenderInterface::RenderCompiledGeometry(Rocket::Core::CompiledGeometryHandle ROCKET_UNUSED_PARAMETER(geometry), const Rocket::Core::Vector2f& ROCKET_UNUSED_PARAMETER(translation))
{
...
void LibRocketRenderInterface::ReleaseCompiledGeometry(Rocket::Core::CompiledGeometryHandle ROCKET_UNUSED_PARAMETER(geometry))
{
	ROCKET_UNUSED(geometry);
}
...
void LibRocketRenderInterface::SetContext(void * context)
{
}

bool LibRocketRenderInterface::AttachToNative(void * nativeWindow)
{
	return false;
}

void LibRocketRenderInterface::DetachFromNative(void)
{
}

void LibRocketRenderInterface::PrepareRenderBuffer(void)
{
}

void LibRocketRenderInterface::PresentRenderBuffer(void)
{
}
...
void SUI::LoadDocument(std::string path) {
	document = context->LoadDocument(path.c_str());
	if (document != NULL)
		document->Show();
}

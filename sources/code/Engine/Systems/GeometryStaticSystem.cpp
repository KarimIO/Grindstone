#if 0
#include "GeometryStaticSystem.hpp"
...
SGeometryStatic::SGeometryStatic(MaterialManager *material_system, GraphicsWrapper * graphics_wrapper, std::vector<Grindstone::GraphicsAPI::UniformBufferBinding *> ubbs) : graphics_wrapper_(graphics_wrapper), material_system_(material_system) {
	geometry_info_.ubb_count = ubbs.size();
	geometry_info_.ubbs = new Grindstone::GraphicsAPI::UniformBufferBinding *[ubbs.size()];

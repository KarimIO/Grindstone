...
namespace Grindstone::Renderer {
	class Bloom : public Rendering::RendererFeature {
	public:
		Bloom() : Rendering::RendererFeature("Bloom", Rendering::DeferredRenderGraphOrderEvent::Bloom) {}
		static const char* GetStaticFeatureName() { return "Bloom"; }

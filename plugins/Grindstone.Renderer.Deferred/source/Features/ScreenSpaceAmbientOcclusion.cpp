...
void Grindstone::Renderer::ScreenSpaceAmbientOcclusion::Initialize() {
...
void Grindstone::Renderer::ScreenSpaceAmbientOcclusion::CreateSsaoKernelAndNoise() {
...
void Grindstone::Renderer::ScreenSpaceAmbientOcclusion::Bind(
	...
	Grindstone::Renderer::RenderGraphBuilderResourceRef ssaoRef = renderGraphBuilder.CreateGraphicsPass<Grindstone::Renderer::RenderGraphBuilderResourceRef>(

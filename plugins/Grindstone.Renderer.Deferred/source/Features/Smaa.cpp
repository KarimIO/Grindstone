...
static Grindstone::Renderer::RenderGraphBuilderResourceRef SmaaEdgeDetectionPass(
	...
	return renderGraphBuilder.CreateGraphicsPass<Grindstone::Renderer::RenderGraphBuilderResourceRef>(
		...
		[lightingImageRef, pointSampler](Grindstone::Renderer::GraphicsRenderGraphBuilderPass<Grindstone::Renderer::RenderGraphBuilderResourceRef>& renderPass) {
...
void Grindstone::Renderer::Smaa::Initialize() {

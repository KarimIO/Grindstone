...
void DeferredRenderer::Render(
	...
	Grindstone::Renderer::ShadowPassReturnData shadowOutput = shadows.AddShadowPasses(imageIndex, eyePos, projectionMatrix, viewMatrix, renderGraphBuilder, worldContextSet, [this](auto& a) { PushRenderingStats(a); });
